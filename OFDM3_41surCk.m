...
Egalisateur_ZFE = repmat(C_k(:),1,Nbits);   % Ajustement de la taille de la matrice
...
Y_egalisation = (1./Egalisateur_ZFE).*Y_recu;       % On multiplie les éléments de Y_recu par les éléments correspondants de 1/H_k
